...
//const Sprite = 
  ...
  prependBehavior(newBehavior) {
      let oldActions = this.updateActions;
      this.updateActions = (me) => {
          newBehavior(me);
          oldActions(me);
      }
  ...
  turnOnGravity(accelerationDueTo, terminalVelocity) {
      this.appendBehavior((me) => 
      {
          ...
          // still missing here: on collision, delete momentumY (set to undefined?)
        
          if ((accelerationDueTo > 0 && me.momentumY > terminalVelocity) || (accelerationDueTo < 0 && me.momentumY < terminalVelocity)) me.momentumY = terminalVelocity;
          me.y += me.momentumY;
      });
  }
